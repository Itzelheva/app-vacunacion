export default [
  {
    id: 1,
    title: "BCG",
    description: "La vacunación contra tuberculosis es la medida de prevención primaria fundamental para prevenir enfermedades graves como tuberculosis meníngea y la forma miliar principalmente.",
    doses: 1,
    idealDoseDates: [0],
  ...
  },
  {
    ...
    description: "La vacuna hexavalente ayuda a la prevención y protección de múltiples enfermedades como difteria, hepatitis B, tétanos, tos ferina, poliomielitis e influenza tipo B.",
    doses: 4,
  ...
  },
  {
    id: 4,
    title: "DPT",
    description: "La vacuna DPT protege contra difteria, tos ferina y tétanos. Se aplica como refuerzo a los 4 años de edad.",
    doses: 1,
    idealDoseDates: [48],
    category: "Vacunación en niños de 0 a 9 años",
  },
  {
    id: 5,
    title: "Rotavirus",
    description: "Las vacunas contra rotavirus tienen eficacia contra las gastroenteritis (diarrea) de cualquier grado y contra las formas graves y complicaciones, disminuye el número de hospitalizaciones por gastroenteritis.",
    doses: 2,
    idealDoseDates: [2,4],
    category: "Vacunación en niños de 0 a 9 años",
  },
  {
    ...
    description: "La vacunación contra neumococo es la medida de prevención primaria fundamental para prevenir enfermedades como neumonía o meningitis.",
    doses: 4,
  ...
  },
  {
    id: 7,
    title: "Influenza",
    description: "La vacunación contra influenza es la medida de prevención primaria fundamental para prevenir la enfermedad y sus complicaciones como neumonía o la muerte por esta enfermedad.",
    doses: 2,
    idealDoseDates: [6,7],
    category: "Vacunación en niños de 0 a 9 años",
  },
  ...
  },
  {
    id: 9,
    title: "Hepatitis A",
    description: "La vacuna previene la hepatitis A y sus complicaciones. Forma parte de un plan integral de prevención y control de las hepatitis virales.",
    doses: 2,
    idealDoseDates: [12,18],
    category: "Vacunación en niños de 0 a 9 años",
  },
